...
public class EtiquetaClassic extends BodyTagSupport {
	...
	public int doStartTag() throws JspException {
		...
		return EVAL_BODY_BUFFERED;// con esto llamría a dInitBOdy, por si tengo
									// que hacer un preproceso antes de que el
									// cuerpo sea evaluado!
	}
	...
	public int doAfterBody() throws JspException {
		...
		if (nveces > 2)
			// EN EL CUERPO DEL EJEMPLO TENEMOS EL $COUNT CON LO QUE EVALUAMOS
			// LA PAGINA HASTA QUE SEA MAYOR DE DOS
			dval = EVAL_PAGE;
		else
			dval = EVAL_BODY_AGAIN;
