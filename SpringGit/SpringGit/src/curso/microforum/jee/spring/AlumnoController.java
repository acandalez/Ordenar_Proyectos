...
public class AlumnoController {
	...
	// con la anotacion Valid ordenamos a los parametros a ser validados por si
	// no cumplen los requisitos.
	@RequestMapping(method = RequestMethod.POST)
	public String saveRegistration(@Valid Alumno student, BindingResult result,
			ModelMap model) {
		String msj = "exito";
		...
		if (result.hasErrors()) // si hay errores, volvemos al formulario
		{
			...
			model.addAttribute("msjconfirmacion",
					"Señor/a " + student.getFirstName()
