...
public class Passwords {
	...
	final static int passLengthMin = 9; // con esto defino el num min de
										// caracteres de mi password para
										// considerarlo seguro
	final static int passMayusMin = 3; // con esto defino el numero minimo de
										// mayusculas de mi password para
										// considerarlo seguro
	final static int passMinusMin = 3;// con esto defino el numero minimo de
										// minusculas de mi password para
										// considerarlo seguro
	final static int passNumMin = 3; // con esto defino el numero minimo de
										// numeros de mi password para
										// considerarlo seguro

	// pass regular
	final static int passRMayus = 2;
	final static int passRMinus = 2;
	final static int passRNum = 2;

	// pass mala
	final static int passMMayus = 1;
	final static int passMMinus = 2;
	final static int passMNum = 1;
	...
	public boolean esPasswordBuena() { // con esto establesco si la password es
										// segura o no
