...
public class PasswordsRegular {
	/**
	 * @param args
	 */
	String password = null;
	final static int passLengthMin = 6; // con esto defino el num min de
										// caracteres de mi password para
										// considerarlo seguro
	final static int passMayusMin = 2; // con esto defino el numero minimo de
										// mayusculas de mi password para
										// considerarlo seguro
	final static int passMinusMin = 2;// con esto defino el numero minimo de
										// minusculas de mi password para
										// considerarlo seguro
	final static int passNumMin = 2; // con esto defino el numero minimo de
										// numeros de mi password para
										// considerarlo seguro

	public PasswordsRegular(String pass) {
	...
	public boolean esPasswordRegular() { // con esto establesco si la password
											// es
											// segura o no
