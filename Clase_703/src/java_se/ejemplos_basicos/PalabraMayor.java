...
public class PalabraMayor {
	...
	public static void main(String[] args) {
		...
		String palabra_mayor = args[0]; //alguna tiene que ser la mayor, de momento, la mayor es la primera, es mi punto de partida. Ahora tendré que comparar esta palabra con el resto, y ver así cuál es realmente la mayor de todas
