...
public class MainHashMap {
	...
	public static void main(String[] args) {
		...
		System.out
				.println("HashMap lo inserta, como Dios le dio a entender...");
		System.out.println(mapa_personas_coche + "\n");

		LinkedHashMap<Coche, Persona> mapa_personas_coche_ordenado_por_clave = (LinkedHashMap<Coche, Persona>) OrdenoHashMap
				.ordenaPorClave(mapa_personas_coche);

		System.out
				.println("Ahora lo tenemos ordenado por el orden natural de clave (matrícula del coche) ;)");
		System.out.println(mapa_personas_coche_ordenado_por_clave + "\n");

		LinkedHashMap<Coche, Persona> mapa_personas_coche_ordenado_por_valor = (LinkedHashMap<Coche, Persona>) OrdenoHashMap
				.ordenaPorValor(mapa_personas_coche);

		System.out
				.println("Ahora lo tenemos ordenado por el orden natural de valor (edad de la persona) ;)");
		System.out.println(mapa_personas_coche_ordenado_por_valor);

		LinkedHashMap<Coche, Persona> mapa_personas_coche_ordenado_por_valor2 = (LinkedHashMap<Coche, Persona>) OrdenoHashMap
				.ordenaPorValor2(mapa_personas_coche);
