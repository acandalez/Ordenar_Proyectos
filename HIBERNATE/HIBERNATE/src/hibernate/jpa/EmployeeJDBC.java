...
import hibernateDAOServices.InstruccionesSQL;
...
public class EmployeeJDBC implements Recuperable {
	...
	public Object ReadEmployee(int n) {
		...
		String JOB_ID = null;
		int SALARY = 0;
		EmployeesDTOJDBC employeeDTO = null;
		...
		try {
			...
			ArrayList<EmployeesDTOJDBC> aEmployess = new ArrayList<EmployeesDTOJDBC>();
			...
			while (rset.next()) {
				...
				EmployeesDTOJDBC newEmployee = new EmployeesDTOJDBC(FIRST_NAME,
